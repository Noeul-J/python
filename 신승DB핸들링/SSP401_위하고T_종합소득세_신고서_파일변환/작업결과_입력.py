...
def Result_Input():
    ...
    try:
        with conn.cursor() as curs:
            ...
            resultQry = "UPDATE TB100023 SET wehagoToConvert='"+result+"', wehagoToConvert_REGDATE='"+regDate+"' WHERE BIZ_ID='"+bizId+"';"
            ...
            if result == 'Y' :
                ...
                logDate = sys.argv[6]
                logQry = "INSERT INTO TB700020 (CSTID, STEP_NAME, LOG, LOG_TIME) VALUES('"+cstId+"', 'wehagoToConvert', '"+errReason+"', '"+logDate+"');"
                curs.execute(logQry)
                conn.commit()
